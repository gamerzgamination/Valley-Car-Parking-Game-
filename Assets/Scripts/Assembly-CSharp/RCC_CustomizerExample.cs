...
public class RCC_CustomizerExample : MonoBehaviour
{
	...
	{
		CheckUIs();
		if (!car && (bool)Object.FindObjectOfType<RCC_Camera>() && (bool)Object.FindObjectOfType<RCC_Camera>().playerCar)
		{
			car = Object.FindObjectOfType<RCC_Camera>().playerCar.GetComponent<RCC_CarControllerV3>();
		}
	}
	...
	public void OpenMenu(GameObject activeMenu)
	{
		...
		{
			activeMenu.SetActive(value: false);
			return;
		}
		wheelsMenu.SetActive(value: false);
		configurationMenu.SetActive(value: false);
		steeringAssistancesMenu.SetActive(value: false);
		colorsMenu.SetActive(value: false);
		activeMenu.SetActive(value: true);
	}
	...
	{
		RCC_Customization.SetGearShiftingThreshold(car, Mathf.Clamp(slider.value, 0.5f, 0.95f));
	}

	public void SetClutchThresholdBySlider(Slider slider)
	{
		RCC_Customization.SetClutchThreshold(car, Mathf.Clamp(slider.value, 0.1f, 0.9f));
	}
